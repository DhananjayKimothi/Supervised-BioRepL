...
"""
self.vector_size = 100  --> chnage this to select vector size
input_path = r"C:\Users\Dhananjay\Desktop\SUPPLIMENTARY--SuVec28March\CODES\EXAMPLES"
output_path = r"C:\Users\Dhananjay\Desktop\SUPPLIMENTARY--SuVec28March\CODES\EXAMPLES" # save folder
file = "T_8.fasta"
...
if __name__ == '__main__':
    import sys
    import os
    input_path = r"C:\Users\Dhananjay\Desktop\Review_PlosOne\fasttext\Herierchical\split2"
    # output_path = r"E:\SuperVec_Codes_25072018\Data\pairs_from1-200\pairs_fasta_files" # save folder
    filepath_out = os.path.join(input_path,"T_100_2_fasttext.fasta")
