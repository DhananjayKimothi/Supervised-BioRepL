...
int main(int argc, char *argv[])
{
	...
	*/
	...
	/*
	printf("%s", path_model);
	printf("%s", path_file_to_be_processed);
	printf("%s", path_save_vectors);
	*/
	
	
	path_model = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\DATA\\uniref_exp3\\Herierchical\\supervec\\M_suv_1.binary";
	path_file_to_be_processed = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\DATA\\uniref_exp3\\T0.fasta";
	path_save_vectors = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\DATA\\uniref_exp3\\Herierchical\\supervec\\T0_1_infr.binary";

	Process();

	/*
	path_model = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\M_suv_1.binary";
	path_file_to_be_processed = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\Tst1.fasta";
	path_save_vectors = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\Tst1_infr.binary";
	Process();


	path_model = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\M_suv_2.binary";
	path_file_to_be_processed = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\Tst2.fasta";
	path_save_vectors = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\Tst2_infr.binary";
	
	Process();

	
	path_model = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\M_suv_3.binary";
	path_file_to_be_processed = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\Tst3.fasta";
	path_save_vectors = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\Tst3_infr.binary";

	Process();

	path_model = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\M_suv_4.binary";
	path_file_to_be_processed = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\Tst4.fasta";
	path_save_vectors = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\Clf_experiments\\Sub-CellularLocation\\suv\\Tst4_infr.binary";
	...
	*/
	...
	/*
	path_model = "C:\\Users\\Dhananjay\\Desktop\\HSuperVec_BLAST\\Largest_8class\\test\\M_gamma_pt5.binary";
	path_file_to_be_processed = "C:\\Users\\Dhananjay\\Desktop\\HSuperVec_BLAST\\Largest_8class\\test\\Q_DB.fasta";
	path_save_vectors = "C:\\Users\\Dhananjay\\Desktop\\HSuperVec_BLAST\\Largest_8class\\test\\Q_DB_infer_suv.binary";
	*/
	/*
	path_file_to_be_processed = "E:\\inferringPPI\\PPI_data_from_Fei_Guo\\RL_similarity_based_ppi_pred\\test_data_split4.fasta"; //non_interacting
	path_model = "E:\\RL_for_local_similarity\\data\\out\\M_s2v_0.binary";
	path_save_vectors = "E:\\inferringPPI\\PPI_data_from_Fei_Guo\\RL_similarity_based_ppi_pred\\test_data_split4.binary"; // pos_neg
	*/
	//printf("%s", argv[1]);
	//Process();
		
	/*
	path_model = "E:\\SuVec_journal_new_ideas\\Lbl_unlbl_training\\100class_exp\\M_s2v.binary";
	path_file_to_be_processed = "E:\\SuVec_journal_new_ideas\\Lbl_unlbl_training\\100class_exp\\Q_DB.fasta";
	path_save_vectors = "E:\\SuVec_journal_new_ideas\\Lbl_unlbl_training\\100class_exp\\Q_DB_s2v.binary";
	//printf("%s", argv[1]);
	Process();
	*/
