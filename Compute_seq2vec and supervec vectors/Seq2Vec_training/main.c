...
#define MAXLINE 10000  // maximum length of sequence in a line
...
void Process(int testNum, int Training)
{
	...
	for (int iterations = 0; iterations < Iterations; iterations++) // iteration over multiple epochs
	{
		...
		for (int family = 0; family < num_families; family++)
			//for (int family = num_families - 1; family >= 0; family--)	// over 1 epoch
		{
...
int main(int argc, char *argv[])
{
	...
	path_save_model = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\DATA\\uniref_exp3\\seq2vec\\M_s2v.binary";
	path_file_to_be_processed = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\DATA\\uniref_exp3\\T0.fasta";
	path_save_vectors = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\DATA\\uniref_exp3\\seq2vec\\T_s2v.binary";
	doctag_path = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\DATA\\uniref_exp3\\doctag_txt0.txt";
	vocab_path = "C:\\Users\\Dhananjay\\Desktop\\Review_PlosOne\\DATA\\uniref_exp3\\vocab_txt0.txt";
